...
//        native_library_loaded = false;
        System.out.println("native_library_loaded = " + native_library_loaded);
    }
     ...
     * @throws GeneralSecurityException when HMAC_SHA256 is not available.
     */
    public static byte[] scryptJ(final byte[] passwd, byte[] salt, int N, int r, int p, int dkLen) throws GeneralSecurityException {
