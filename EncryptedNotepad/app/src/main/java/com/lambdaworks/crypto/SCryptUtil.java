...
// *
// * Format: <code>$64b$PARAMS$SALT$KEY</code>.
// *
// * <dl>
...
// * </dl>
// *
// * Uses a 128-bit salt and 512-bit derived key.
// *
// * @author  Will Glozer
// */
...
//
//    private static final int OUTPUT_BYTES = 64;
//
//    /**
...
//     */
//    public static byte[] scrypt(String passwd, byte[] salt, int N, int r, int p) {
//        try {
//
//            return
//
...
////
////            return "$" + OUTPUT_BYTES + "b$" + params + '$' +
////                    Arrays.toString(encode(salt)) + '$' +
////                    Arrays.toString(encode(derived));
//
...
////
////            if (parts.length != 5 || !parts[1].equals(String.valueOf(OUTPUT_BYTES) + 'b')) {
...
////
////            byte[] derived1 = SCrypt.scrypt(passwd.getBytes(CHARSET), salt, N, r, p, OUTPUT_BYTES);
////
